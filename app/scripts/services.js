...
tmmSer.factory("utilSer", function utilSerFactory(valSer, $timeout, $q, $location){
  ...
  return{
    initSlide : function($scope){
      ...
      var slideDetails=[
        {"imgSrc": "img/tomslide1.jpg", "link": "http://ckvapps.blogspot.in/2015/12/about-trackourmoney.html"},
        {"imgSrc": "img/tomslide2.jpg", "link": "http://ckvapps.blogspot.in/2015/12/managing-group.html"}
      ];
